...
@@ -22,7 +21,8 @@ def ejecutar_tasacion_v2(marca, modelo, anio, horas, observaciones, fotos_subida
...
@@ -31,20 +31,26 @@ def ejecutar_tasacion_v2(marca, modelo, anio, horas, observaciones, fotos_subida
